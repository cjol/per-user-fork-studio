/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c95cdec465ef9c14ce1aedb8daa93db7)
// Runtime types generated with workerd@1.20260625.1 2026-06-11 nodejs_compat
interface __BaseEnv_Env {
	ARTIFACTS: Artifacts;
	LOADER: WorkerLoader;
	AI: Ai;
	USERAPP: DurableObjectNamespace<import("./src/server").UserApp>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "UserApp";
	}
